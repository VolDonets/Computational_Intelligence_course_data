...
5. TODO 1: your task here is to add a few tool-function to `./mcp_server/server.py` like it was in the example.
6. TODO 2: check if your code works using "Claude Desktop" and connect it with your MCP server.
